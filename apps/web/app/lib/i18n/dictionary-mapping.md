# Chinese-to-Key Mapping Table

This document maps all Chinese text to their corresponding i18n keys for the translation dictionaries.
...
| dashboard.nav.habits | 习惯 |
| dashboard.nav.dailies | 日常 |
| dashboard.nav.todos | 待办 |
| dashboard.nav.rewards | 奖励 |
| dashboard.nav.project | 项目 |
| dashboard.nav.requirement | 需求 |
| dashboard.nav.task | 任务 |
| dashboard.nav.defect | 缺陷 |
| dashboard.nav.notifications | 通知 |
| dashboard.nav.setting | 设置 |
...
| rewards.rewardYourself | 奖励自己 |
| rewards.buyRewards | 通过完成任务赚取金币来购买奖励！ |
...
| overview.filters.strong | Strong |
| overview.filters.weak | Weak |
| overview.filters.due | Due |
| overview.filters.notDue | Not Due |
| overview.filters.active | Active |
| overview.filters.scheduled | Scheduled |
| overview.filters.complete | Complete |
| overview.filters.custom | Custom |
| overview.filters.wishlist | Wishlist |
