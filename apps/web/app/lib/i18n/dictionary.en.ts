export const enUS = {
  ...
  requirement: {
    ...
    sub: {
      createTitle: 'Add Sub-requirement',
      parentLabel: 'Parent Requirement',
      nameLabel: 'Sub-requirement Name',
      namePlaceholder: 'Enter sub-requirement name',
      createButton: 'Create Sub-requirement',
      startDate: 'Start Date',
      endDate: 'End Date',
      points: 'Points',
      description: 'Description',
      descriptionPlaceholder: 'Briefly describe the sub-requirement...',
      empty: 'No sub-requirements yet',
      create: 'Create one',
    },
    error: {
      parentNotFound: 'Parent requirement not found',
      circularReference: 'Cannot set a requirement as its own sub-requirement',
      nameRequired: 'Sub-requirement name is required',
      nameMinLength: 'Sub-requirement name must be at least 2 characters',
      nameMaxLength: 'Sub-requirement name cannot exceed 100 characters',
      endDateBeforeStart: 'End date cannot be earlier than start date',
      pointsNegative: 'Points cannot be negative',
    },
  },
  rewards: {
