...
export default function Page() {
  ...
  const parseJsonResponse = async (
    ...
    success?: boolean;
    message?: string;
    user?: { id: string; nickname: string; isAdmin?: boolean };
  }> => {
            ...
            <div className="flex flex-col h-[540px]">
              ...
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="text-sm text-gray-600 brand-text">Agile Person Manage</div>
                  <div
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-left mr-2">
                      <p className="text-xs text-gray-600 leading-relaxed login-hint">
                        {isSignUpMode ? t('login.hints.joinUs') : t('login.hints.makeFulfilling')}
                      </p>
                    </div>
                    <AgButton
                      type="submit"
              ...
              >
                <div className="flex justify-between items-start">
                  ...
                  <img src="/me.png" alt="me" className="w-12 h-12 rounded-full object-cover" />
                </div>
